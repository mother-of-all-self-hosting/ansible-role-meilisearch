...
>[!WARNING]
> It is [not recommended](https://www.meilisearch.com/docs/resources/self_hosting/security/basic_security#obtaining-api-keys-in-a-self-hosted-instance) to use the master key for operations anything but managing other API keys. Refer to [this section](#obtaining-api-keys) below for the instruction to obtain those keys.
...
Refer to [the official documentation](https://www.meilisearch.com/docs/learn/self_hosted/configure_meilisearch_at_launch) for a complete list of Meilisearch's config options that you can put in `meilisearch_environment_variables_additional_variables`.
...
Refer to [this page](https://www.meilisearch.com/docs/getting_started/overview) on the documentation about its usage.
